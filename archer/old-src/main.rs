...
fn main() -> Result<(), String> {
    ...
    const TILE: PixelCoord<u32> = PixelCoord::new(1, 1);
    ...
    let spheres = vec![
        Box::new(SceneObject {
            ...
            material: Arc::new(PerfectMirror {}),
            node_index: 0,
        }),
        Box::new(SceneObject {
            geometry: Arc::new(Sphere {
            ...
            material: Arc::new(NormalMaterial {}),
            node_index: 0,
        }),
        Box::new(SceneObject {
            geometry: Arc::new(Sphere {
    ...
    let pixels =
        vec![vec![ColorVector::new(0.0, 0.0, 0.0); RESOLUTION.y as usize]; RESOLUTION.x as usize];
