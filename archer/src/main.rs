...
fn main() {
    const RESOLUTION: [usize; 2] = [1920, 1080];
    let mut image: RgbImage = ImageBuffer::new(RESOLUTION[0] as u32, RESOLUTION[1] as u32);
    ...
    for x in 0..RESOLUTION[0] as u32 {
        for y in 0..RESOLUTION[1] as u32 {
